...
mod tests {
    ...
    fn emulate_successful_auth_key_gen_flow() -> Result<(), Error> {
        let step1_random = hex::into_bytes("4e44b426241e8b839153122d44585ac6");
        let step1_request = hex::into_bytes::<20>("f18e7ebe4e44b426241e8b839153122d44585ac6");
        let step1_response = hex::into_bytes::<80>(
        ...
        let step2_random = hex::into_bytes(
        ...
        let step2_request = hex::into_bytes::<320>(
        ...
        let step2_response = hex::into_bytes::<632>(
        ...
        let step3_random = hex::into_bytes(
        ...
        let step3_request = hex::into_bytes::<376>(
